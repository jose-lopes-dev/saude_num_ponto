...
<head>
    ...
    <meta charset="utf-8" />
    <title>Ativos | Saúde Num Ponto</title>
    ...
    <link rel="stylesheet" href="src/css/ativos.css">
    <!-- custom Css-->
...
<body>
   ...
   <div class="dropdown-menu dropdown-menu-end">
        ...
        <div id="scrollbar">
            <div class="container-fluid">
                <ul class="navbar-nav" id="navbar-nav">
                    ...
                    <li class="nav-item">
                        <a href="ativos.php" class="nav-link menu-link active">
    ...
    <div class="main-content">
        ...
        <div class="page-content">
            <div class="container-fluid">
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header d-flex justify-content-between align-items-center">
                                <span class="fw-semibold">Lista de ativos</span>
                                <button id="btn-export-csv" class="btn btn-sm btn-light">Exportar CSV</button>
                            </div>
                ...
                <!-- Modal: Gráfico de Ativo -->
                <div class="modal fade" id="modalAssetChart" tabindex="-1" aria-hidden="true">
                    <div class="modal-dialog modal-lg modal-dialog-centered">
                        <div class="modal-content bg-dark text-light">
                            <div class="modal-header border-0">
                                <h5 class="modal-title">Evolução do Ativo</h5>
                                <button type="button" class="btn-close btn-close-white"
                                    data-bs-dismiss="modal"></button>
                            </div>
                            <div class="modal-body">
                                <div id="chart-area-ativo" style="min-height:360px;"></div>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <!-- 2) FORMULÁRIO FULL-WIDTH -->
                <div class="row g-3">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header fw-semibold">Adicionar novo ativo</div>
                            <div class="card-body">
                                <form id="form-add-asset" class="row g-3">
                                    <div class="col-12">
                                        <label class="form-label">Nome do ativo</label>
                                        <input type="text" class="form-control" name="nome"
                                            placeholder="Ex.: Portátil Dell Latitude" required>
                                    </div>

                                    <div class="col-12 col-md-6">
                                        <label class="form-label">Valor inicial (€)</label>
                                        <input type="number" class="form-control" name="valor_inicial" min="0"
                                            step="0.01" required>
                                    </div>
                                    <div class="col-12 col-md-6">
                                        <label class="form-label">Vida útil (anos)</label>
                                        <input type="number" class="form-control" name="vida_util" min="1" step="1"
                                            required>
                                    </div>

                                    <div class="col-12 col-md-6">
                                        <label class="form-label">Categoria</label>
                                        <select class="form-select" id="sel-categoria" name="id_categoria" required>
                ...
                <div class="row g-3 align-items-stretch">
                    <div class="col-12 col-lg-6">
                        <div class="card h-100">
                            <div class="card-header d-flex justify-content-between">
                                <span class="fw-semibold">Valor Depreciado vs Justo valor</span>
                                <small class="text-muted">por ativo</small>
                            </div>
                            <div class="card-body">
                                <div id="chart-bar-inicial-vs-justo" style="min-height: 340px;"></div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-12 col-lg-6">
                        <div class="card h-100">
                            <div class="card-header d-flex justify-content-between">
                                <span class="fw-semibold">Depreciação mensal</span>
                                <small class="text-muted">total</small>
                            </div>
                            <div class="card-body">
                                <div id="chart-line-depreciacao-mensal" style="min-height: 340px;"></div>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <script src="src/js/ativos.js"></script>
