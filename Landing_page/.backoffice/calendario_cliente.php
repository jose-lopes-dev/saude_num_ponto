...
<head>
    ...
    <link rel="stylesheet" href="src/css/agenda_pt.css">
...
<body>
            ...
            <div id="scrollbar">
                <div class="container-fluid">
                    <ul class="navbar-nav" id="navbar-nav">
                        ...
                        <li class="nav-item">
                            <a href="calendario_cliente.php" class="nav-link menu-link active">
    ...
    <script src="src/js/calendario_cliente.js"></script>
</body>
