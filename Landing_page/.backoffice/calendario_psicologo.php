...
<head>
    ...
    <meta charset="utf-8" />
    <title>Calendário | Saúde Num Ponto</title>
...
<body>
            ...
            <div id="scrollbar">
                <div class="container-fluid">
                    <ul class="navbar-nav" id="navbar-nav">
                        ...
                        <li class="nav-item">
                            <a href="calendario_psicologo.php" class="nav-link menu-link active">
                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        ...
                        <div class="col-xl-3">
                            ...
                            <button class="btn btn-success w-100 mb-3" id="btn-new-event">
                                + Criar Evento
                            </button>

                            <p class="text-muted mb-2">Tipos de eventos</p>

                            <div id="external-events">

                                <div class="external-event bg-primary-subtle text-primary p-2 mb-2 rounded"
                                    data-categoria="Sessão Psicologia">
                                    Sessão Psicologia
                                </div>

                                <div class="external-event bg-secondary-subtle text-secondary p-2 mb-2 rounded"
                                    data-categoria="Evento Próprio">
                                    Evento Próprio
                                </div>
                                    ...
                                    <form id="form-event">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <select id="event-category" class="form-select">
                                                <option value="Sessão Psicologia">Sessão Psicologia</option>
                                                <option value="Evento Próprio">Evento Próprio</option>
                                            </select>
                                        </div>
                                        ...
                                        <div class="mb-3">
                                            <label>Fim</label>
                                            <input type="datetime-local" id="event-date-end" class="form-control"
                                                required>
                                        </div>
                                        ...
                                        <div class="d-flex justify-content-end gap-2">
                                            ...
                                            <button type="button" class="btn btn-success d-none"
                                                id="btn-conclude-event">Concluir</button>
                                            <button type="button" class="btn btn-danger d-none"
                                                id="btn-delete-event">Remover</button>
    ...
    <script src="src/js/calendario_psicologo.js"></script>
