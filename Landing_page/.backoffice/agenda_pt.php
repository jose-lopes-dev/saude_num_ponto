...
<head>
    ...
    <meta charset="utf-8" />
    <title>Agenda | Saúde Num Ponto</title>
...
<body>
        ...
        <div id="scrollbar">
            <div class="container-fluid">
                <ul class="navbar-nav" id="navbar-nav">
                    ...
                    <li class="nav-item">
                        <a href="agenda_pt.php" class="nav-link menu-link active">
                ...
                <div class="agenda-card">
                    <div class="agenda-topbar">
                        ...
                        <div class="agenda-right">
                            <button type="button" id="btnHorarioSemanal" class="btn-agenda">Horário semanal</button>
                        </div>
                    </div>
                    <!-- Cartão com o FullCalendar -->
                    <div class="row">
                        <div class="col-12">
    ...
    <script src="src/js/agenda_pt.js"></script>
