...
<body>
        ...
        <div id="scrollbar">
            <div class="container-fluid">
                <ul class="navbar-nav" id="navbar-nav">
                    ...
                    <li class="nav-item">
                        <a href="consultas_pt.php" class="nav-link menu-link active">
            ...
            <div class="container-fluid">
                ...
                <div class="row g-4">
                    ...
                    <div class="col-lg-8">
                        ...
                        <!-- CONSULTAS PENDENTES -->
                        <div class="card pt-card-lg pt-topbar-card mt-24 shadow-sm p-4 rounded-4">
                            <h3 class="fw-semibold mb-2">Consultas Pendentes</h3>
                            <p class="text-muted mb-3">
                                Consultas de treino aguardam a sua decisão.
                            </p>
                        ...
                        <div class="card pt-card-lg pt-topbar-card mt-24 shadow-sm p-4 rounded-4">
                            ...
                            <p class="text-muted mb-3">
                                Estas consultas já foram aceites e aparecem no seu calendário.
                            </p>
                        ...
                        <div class="card pt-card-lg pt-topbar-card mt-24 shadow-sm p-4 rounded-4">
                            ...
                            <p class="text-muted mb-3">
                                Consultas recusadas não aparecem no calendário.
                            </p>
                    ...
                    <div class="col-lg-4">
                        <div class="card pt-card-lg pt-topbar-card mt-24 shadow-sm p-4 rounded-4">
                            ...
                            <p class="text-muted small">
                                Estados possíveis das consultas de treino:
                            </p>
                ...
                <!-- TABELA NO FUNDO (COMO NO CLIENTE) -->
                <div class="row mt-5">
                    <div class="col-12">
                        <div class="card pt-card-lg pt-topbar-card mt-24 shadow-sm p-4 rounded-4">
                            ...
                            <div class="table-responsive">
                                <table class="table align-middle mb-0">
                                    ...
                                    <tbody id="tabela-proximas-consultas-pt">
                                        <tr>
    ...
    <script src="src/js/consultaPT.js"></script>
