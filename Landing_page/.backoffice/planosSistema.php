...
<head>
    ...
    <meta charset="utf-8" />
    <title>Planos | Saúde Num Ponto</title>
    ...
    <link rel="stylesheet" href="src/css/planosSistema.css">

</head>

<body class="pt-page planos-sistema-page">
...
<!-- Begin page -->
    <div id="layout-wrapper">
                ...
                <div class="navbar-header snp-topbar">
                    <div class="d-flex align-items-center">
                        ...
                        <div class="topbar-page-title d-none d-lg-flex flex-column ms-3">
                            <span class="topbar-title">Planos do Sistema</span>
                            <ol class="breadcrumb breadcrumb-sm mb-0">
                                <li class="breadcrumb-item">
                                    <a href="dashboard_cliente.php">Cliente</a>
                                </li>
                                <li class="breadcrumb-item active" aria-current="page">Planos do Sistema</li>
                            </ol>
                        </div>
            ...
            <div id="scrollbar">
                <div class="container-fluid">
                    <ul class="navbar-nav" id="navbar-nav">
                        ...
                        <li class="nav-item">
                            <a href="planosSistema.php" class="nav-link menu-link active">
        ...
        <div class="main-content">
            <div class="page-content">
                <div class="container-fluid">
                    ...
                    <div class="planos-top-row">
                        <div class="planos-top-left">
                            <h4 class="planos-title">Planos Disponíveis</h4>
                            <p class="planos-subtitle">Escolhe o plano que melhor se adapta a ti.</p>
                        </div>

                        <div id="planoAtualInfo"></div>
                    </div>

                    <div class="row g-4" id="zonaPlanos">
                        ...
                        <div class="col-md-4">
                            <div class="card pt-card-lg shadow-sm">
                                <div class="card-body">
                                    ...
                                    <ul class="mt-3">
                                        <li>Acesso à App</li>
                                        <li>Plano alimentar padrão</li>
                                        <li>Treinos genéricos</li>
                                    </ul>
                                </div>
                                <div class="card-footer bg-transparent border-0">
                                    <button class="pt-btn-outline w-100 btnComprarPlano" data-idservico="1">
                                        Selecionar
                                    </button>
                                </div>
                            </div>
                        ...
                        <div class="col-md-4">
                            <div class="card pt-card-lg shadow-sm">
                                <div class="card-body">
                                    <h5 class="card-title"><span class="badge-popular">Popular</span>Plano Médio</h5>
                                    <h3>70€ <small class="text-muted">/ mês</small></h3>

                                    <ul class="mt-3">
                                        <li>Plano alimentar personalizado</li>
                                        <li>1 sessão com PT</li>
                                        <li>1 consulta nutricionista</li>
                                        <li>Suporte ilimitado</li>
                                    </ul>
                                </div>
                                <div class="card-footer bg-transparent border-0">
                                    <button class="pt-btn-outline w-100 btnComprarPlano" data-idservico="2">
                                        Comprar
                                    </button>
                                </div>
                            </div>
                        ...
                        <div class="col-md-4">
                            <div class="card pt-card-lg shadow-sm">
                                <div class="card-body">
                                    ...
                                    <h3>160€ <small class="text-muted">/ mês</small></h3>

                                    <ul class="mt-3">
                                        <li>Plano alimentar personalizado</li>
                                        <li>4 sessões com PT</li>
                                        <li>Consulta nutricionista</li>
                                        <li>Acompanhamento contínuo</li>
                                    </ul>
                                </div>
                                <div class="card-footer bg-transparent border-0">
                                    <button class="pt-btn-outline w-100 btnComprarPlano" data-idservico="3">
                                        Comprar
                                    </button>
                                </div>
                            </div>
                    ...
                    <!-- MODAL PAGAMENTO -->
                    <div class="modal fade" id="modalPagamentoPlano" tabindex="-1" aria-hidden="true">
                        <div class="modal-dialog modal-lg modal-dialog-centered">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h5 class="modal-title">Pagamento do Plano</h5>
                                    <button type="button" class="btn-close btn-close-white" data-bs-dismiss="modal"
                                        aria-label="Fechar"></button>
                                </div>

                                <div class="modal-body">
                                    <div class="mb-2 text-muted" id="resumoPlanoPagamento">
                                        <!-- preenchido pelo JS -->
                                    </div>
                                    ...
                                    <button id="btnConfirmarPagamento" class="pt-btn w-100 mt-3">
                                        Confirmar Pagamento
                                    </button>
                                </div>
                            </div>
        ...
        <script src="src/js/planosSistema.js"></script>
