    ...
    linechartZoomColors =
        (linechartBasicColors &&
            ((options = {
                ...
                title: { text: "Pagamentos por mês", align: "left", style: { fontWeight: 500 } },
    ...
    linechartannotationsColors =
        (linechartDashedColors &&
            ((options = {
                ...
                series: [
                    { name: "Nutricionista", data: [45, 52, 38, 24, 33, 26, 21, 20, 6, 8, 15, 10] },
                    { name: "Psicólogo", data: [36, 42, 60, 42, 13, 18, 29, 37, 36, 51, 32, 35] },
                    { name: "Personal Trainer", data: [89, 56, 74, 98, 72, 38, 64, 46, 84, 58, 46, 49] },
                ],
                title: { text: "Pagamento por função", align: "left", style: { fontWeight: 500 } },
                markers: { size: 0, hover: { sizeOffset: 6 } },
                xaxis: { categories: ["Jan", "Feb", "Mar", "Apr", "May", "Jun", "Jul", "Aug", "Sep", "Oct", "Nov", "Dez"] },
                tooltip: {
                    y: [
                        {
                            title: {
