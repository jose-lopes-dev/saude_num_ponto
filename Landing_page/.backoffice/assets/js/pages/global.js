...
var options,
    ...
    swiper =
        ...
        var options = {
    series: [8457.73, 13484.00, 5026.27], // Custos, Rendimentos, Lucro
    chart: {
        type: 'donut',
        height: 320
    },
    labels: ['Custos', 'Rendimentos', 'Lucro'],
    colors: ['#e74c3c', '#27ae60', '#2980b9'], // vermelho, verde, azul
    legend: {
        position: 'bottom'
    },
    dataLabels: {
...
var chart = new ApexCharts(document.querySelector("#custos_donut_chart"), options);
chart.render();
