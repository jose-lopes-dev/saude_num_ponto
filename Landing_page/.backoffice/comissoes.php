...
<head>
  <meta charset="utf-8" />
  <title>Vencimento | Saúde Num Ponto</title>
  ...
  <link rel="stylesheet" href="src/css/comissoes.css">
...
<body>
    ...
    <div id="scrollbar">
      <div class="container-fluid">
        <ul class="navbar-nav" id="navbar-nav">
          ...
          <li class="nav-item">
            <a href="comissoes.php" class="nav-link menu-link active">
        ...
        <div class="row">
          <div class="col-12">
            <div class="page-title-box d-sm-flex align-items-center justify-content-between bg-transparent">
              <h4 class="mb-sm-0">Vencimento</h4>
            </div>
          </div>
        </div>
        <!-- end page title -->

        <div id="comissao-page" class="container-fluid">
          <!-- Tabs -->
          <ul class="nav nav-tabs mb-3" role="tablist">
            <li class="nav-item" role="presentation">
              <button class="nav-link active" data-bs-toggle="tab" data-bs-target="#tab-rh-comissao" type="button"
                role="tab">
                Pagamento de Honorários
              </button>
            </li>
            <li class="nav-item" role="presentation">
              <button class="nav-link" data-bs-toggle="tab" data-bs-target="#tab-rh-vencimento" type="button"
                role="tab">
          ...
          <div class="tab-content">
            ...
            <!-- ===================== Pagamento de Honorários ===================== -->
            <div class="tab-pane fade show active" id="tab-rh-comissao" role="tabpanel">
              <div class="card pt-card-lg pt-topbar-card mt-2">
                <div class="card-body">
                  <div class="table-responsive">
                    <table id="tabelaComissoes" class="table table-striped">
                      <thead>
                        <tr>
                          <th>Nome</th>
                          <th>Função</th>
              ...
              <div class="row">
                <div class="col-lg-6">
                  <div class="card pt-card-lg pt-topbar-card mt-2">
                    <div class="card-body">
                      <h4 class="card-title">Evolução do Pagamento</h4>
                ...
                <div class="col-lg-6">
                  <div class="card pt-card-lg pt-topbar-card mt-2">
                    <div class="card-body">
                      <h4 class="card-title">Pagamento por Função</h4>
                      <canvas id="chartComissoesFuncao"></canvas>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <!-- ===================== Pagamento de Colaboradores ===================== -->
            <div class="tab-pane fade" id="tab-rh-vencimento" role="tabpanel">
              <div class="card pt-card-lg pt-topbar-card mt-2">
                <div class="card-body">
                  <div class="table-responsive">
                    <table id="tabelaSalarios" class="table table-striped">
                      <thead>
                        <tr>
                          <th>Nome</th>
                          <th>Função</th>
  ...
  <!-- JS Libraries -->
  <!-- JS Libraries essenciais -->
  <script src="https://code.jquery.com/jquery-3.7.1.min.js"></script>

  <!-- Usa APENAS UM Bootstrap (escolhe o local ou o CDN; aqui fico pelo local do template) -->
  <script src="assets/libs/bootstrap/js/bootstrap.bundle.min.js"></script>

  <!-- DataTables para a tabela -->
  <script src="https://cdn.datatables.net/1.13.6/js/jquery.dataTables.min.js"></script>
  <script src="https://cdn.datatables.net/buttons/2.4.1/js/dataTables.buttons.min.js"></script>

  <!-- Chart.js para os gráficos desta página -->
