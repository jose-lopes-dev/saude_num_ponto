...
<body>
            ...
            <div id="scrollbar">
                <div class="container-fluid">
                    <ul class="navbar-nav" id="navbar-nav">
                        ...
                        <li class="nav-item">
                            <a href="consulta_psicologo.php" class="nav-link menu-link active">
                    ...
                    <div class="row mb-3">
                        <div class="col-12">
                            <div
                                ...
                                <h4 class="mb-sm-0 fw-bold">Sessões</h4>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row g-4">
                        ...
                        <div class="col-lg-8">
                            ...
                            <div class="card shadow-sm p-4 rounded-4">
                                <h3 class="fw-semibold mb-2">Sessões Pendentes</h3>
                                <p class="text-muted mb-3">Aguarde a decisão para cada sessão marcada pelos pacientes.
                                </p>

                                <div id="lista_pendentes" class="list-group">
                                </div>
                            </div>

                            <!-- Aceites -->
                            <div class="card shadow-sm p-4 rounded-4 mt-4">
                                <h3 class="fw-semibold mb-2">Sessões Aceites</h3>
                                <p class="text-muted mb-3">Estas sessões já foram aceites por si.</p>

                                <div id="lista_aceites" class="list-group">
                                </div>
                            </div>

                            <!-- Recusadas -->
                            <div class="card shadow-sm p-4 rounded-4 mt-4 mb-5">
                                <h3 class="fw-semibold mb-2">Sessões Recusadas</h3>
                                <p class="text-muted mb-3">Sessões recusadas não aparecerão no seu calendário.</p>

                                <div id="lista_recusadas" class="list-group">
                                </div>
                            </div>
                        ...
                        <div class="col-lg-4">
                            ...
                            <div class="card shadow-sm p-4 rounded-4 mb-4">
                                ...
                                <p class="text-muted small">Estados das sessões:</p>
    ...
    <script src="src/js/consulta_psicologo.js"></script>
</body>
