...
<head>
    ...
    <meta charset="utf-8" />
    <title>Perfil | Saúde Num Ponto</title>
...
<body>
                ...
                <div class="navbar-header snp-topbar">
                    <div class="d-flex align-items-center">
                        ...
                        <div class="topbar-page-title d-none d-lg-flex flex-column ms-3">
                            <span class="topbar-title">Perfil</span>
                            <ol class="breadcrumb breadcrumb-sm mb-0">
                                <li class="breadcrumb-item">
                                    <a href="perfil_nutricionista.php">Nutricionista</a>
                                </li>
                        ...
                        <div class="col-xl-3">
                            <div class="card">
                                <div class="card-body text-center">
                                    ...
                                    <!-- O LABEL CONTINUA A FUNCIONAR -->
                                    <label for="uploadFoto" class="d-inline-block">
                                        <img id="fotoPerfil" src="" class="rounded-circle img-thumbnail mb-2">
                                        <div>
                                    ...
                                    <h5 id="nomePerfil">---</h5>
                                    <p class="text-muted mb-0" id="funcaoPerfil">---</p>
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <form id="formPerfil" class="row g-3" enctype="multipart/form-data">
                                        ...
                                        <!-- INPUT DA FOTO (DENTRO DO FORM, CORRETO) -->
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <input type="text" class="form-control" id="qualificacao"
                                                name="qualificacao">
                                        </div>

                                        <div class="col-md-6">
                                            <label class="form-label">Anos de Experiência</label>
                                            <input type="number" class="form-control" id="experiencia_anos"
                                                name="experiencia_anos" min="0">
                                        </div>

                                        <div class="col-12 d-flex justify-content-end gap-2 mt-3">
                                            <button type="button" class="btn btn-secondary"
                                                onclick="carregarPerfilPrestador()">
                                                Cancelar
                                            </button>
    ...
    <script src="src/js/perfilPrestador.js"></script>
