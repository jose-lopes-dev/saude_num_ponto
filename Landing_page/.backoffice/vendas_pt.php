...
<body>
        ...
        <div id="scrollbar">
            <div class="container-fluid">
                <ul class="navbar-nav" id="navbar-nav">
                    ...
                    <li class="nav-item">
                        <a href="vendas_pt.php" class="nav-link menu-link active">
                            ...
                            <div class="card-body">
                                <form class="row g-3">
                                    ...
                                    <div class="col-12">
                                        ...
                                        <select class="form-select" id="id_servico"></select>
                                    </div>
                                    ...
                                    <div class="col-md-6 pt-body">
                                        <label class="form-label">Método Pagamento</label>
                                        <select class="select2" id="metodo_pagamento">
                                    ...
                                    <div class="col-md-6 pt-body">
                                        ...
                                        <select class="select2" id="id_estado">
                                    ...
                                    <div class="col-12">
                                        <button type="button" class="btn pt-btn w-100"
                                            onclick="registaVenda()">Guardar</button>
                                    </div>
                        ...
                        <div class="card pt-card-lg pt-topbar-card mt-2">
                            ...
                            <div class="card-body">
                                <div class="table-responsive">
                                    <table class="table table-striped align-middle" id="tableVendas">
                                        <thead>
                                            <tr>
                                                <th>ID</th>
                                                <th>Data</th>
    ...
    <script src="src/js/vendas_pt.js"></script>
