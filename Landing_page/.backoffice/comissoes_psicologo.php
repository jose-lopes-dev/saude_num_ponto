...
<body>
            ...
            <div id="scrollbar">
                <div class="container-fluid">
                    <ul class="navbar-nav" id="navbar-nav">
                        ...
                        <li class="nav-item">
                            <a href="comissoes_psicologo.php" class="nav-link menu-link active">
                ...
                <div class="container-fluid">
                    ...
                    <div class="row g-3 mb-3">
                        <div class="col-12 col-md-4">
                            <div class="card">
                                <div class="card-body">
                                    <div class="text-muted">Total ganho em sessões</div>
    ...
    <script src="src/js/comissoes_psicologo.js"></script>
