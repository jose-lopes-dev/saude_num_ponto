                        ...
                        <div class="topbar-page-title d-none d-lg-flex flex-column ms-3">
                            ...
                            <ol class="breadcrumb breadcrumb-sm mb-0">
                                <li class="breadcrumb-item">
                                    <a href="comissoes_nutricionista.php">Nutricionista</a>
                                </li>
            ...
            <div id="scrollbar">
                <div class="container-fluid">
                    <ul class="navbar-nav" id="navbar-nav">
                        ...
                        <li class="nav-item">
                            <a href="comissoes_nutricionista.php" class="nav-link menu-link active">
                    ...
                    <div class="row g-3 mb-3">
                        <div class="col-12 col-md-4">
                            <div class="card cl-card">
                                <div class="card-body">
                                    <div class="text-muted">Total ganho</div>
                                    <div class="fs-4 fw-semibold" id="kpiTotalGanho">0€</div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-12 col-md-4">
                            <div class="card cl-card">
                                <div class="card-body">
                                    ...
                                    <div class="fs-4 fw-semibold" id="kpiTotalRecebido">0€</div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-12 col-md-4">
                            <div class="card cl-card">
                                <div class="card-body">
                                    <div class="text-muted">Por receber</div>
                                    <div class="fs-4 fw-semibold" id="kpiTotalPorReceber">0€</div>
                                </div>
                            </div>
                        </div>
                    </div>
...
<select id="filtroEstado" class="form-select form-select-sm" style="width: 180px;">
...
<script src="src/js/comissoes_nutricionista.js"></script>
