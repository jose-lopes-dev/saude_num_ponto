            ...
            <div id="scrollbar">
                <div class="container-fluid">
                    <ul class="navbar-nav" id="navbar-nav">
                        ...
                        <li class="nav-item">
                            <a href="chat_pt.php" class="nav-link menu-link active">
                        ...
                        <div class="col-lg-3 col-md-5">
                            <div class="card chat-leftsidebar h-100">
                                ...
                                <div class="card-header d-flex justify-content-between">
                                    ...
                                    <button class="btn btn-sm btn-primary" id="btnNovaConversa">
                ...
                <div class="modal-dialog modal-dialog-centered">
                    <div class="modal-content">
                        ...
                        <div class="modal-footer">
                            ...
                            <button class="btn btn-primary" id="confirmNovaConversa">Iniciar</button>
                        </div>
                    </div>
                </div>
            </div>
