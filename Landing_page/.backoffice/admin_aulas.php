...
<head>
  <meta charset="utf-8" />
  <title>Gestão de Aulas | Saúde Num Ponto</title>
...
<body>
    ...
    <div id="scrollbar">
      <div class="container-fluid">
        <ul class="navbar-nav" id="navbar-nav">
          ...
          <li class="nav-item">
            <a href="admin_aulas.php" class="nav-link menu-link active">
  ...
  <div class="main-content">
    ...
    <div class="page-content">
      <div class="container-fluid">
        ...
        <div class="row">
          <div class="col-12">
            <div class="page-title-box d-sm-flex align-items-center justify-content-between bg-transparent">
              <h4 class="mb-sm-0">Gestão de Aulas</h4>
            </div>
          </div>
        </div>
        <!-- end page title -->
        ...
        <div class="container-fluid my-4">
          <div class="d-flex justify-content-between mb-4">
            <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalNovaAula">
              <i class="ri-add-line align-bottom me-1"></i> Nova Aula
            </button>
          </div>

          <div id="listaAulasAdmin">
        ...
        <!-- MODAL NOVA AULA -->
        <div class="modal fade" id="modalNovaAula">
          <div class="modal-dialog modal-lg">
            <div class="modal-content">
              <div class="modal-header">
                <h5 class="modal-title">Registar Aula</h5>
                <button class="btn-close" data-bs-dismiss="modal"></button>
              </div>

              <div class="modal-body">
                <input type="hidden" id="aula_id_nova">
                <div class="row g-3">

                  <div class="col-md-4">
                    <label class="form-label">Título</label>
                    <input type="text" id="tituloAula" class="form-control">
                  </div>

                  <div class="col-md-8">
                    <label class="form-label">Descrição</label>
                    <input type="text" id="descricaoAula" class="form-control">
                  </div>
                  ...
                  <div class="col-md-3">
                    ...
                    <input type="number" id="duracaoAula" class="form-control">
                  </div>

                  <div class="col-md-3">
                    <label class="form-label">Limite</label>
                    <input type="number" id="limiteAula" class="form-control">
                  </div>

                  <div class="col-md-5">
                    <label class="form-label">Nível</label>
                    <select id="nivelAula" class="form-control">
                  ...
                  <div class="col-md-3">
                    ...
                    <input type="number" id="precoAula" class="form-control">
                  </div>

                  <div class="col-md-4">
                    <label class="form-label">PT</label>
                    <select id="ptAula" class="form-control"></select>
                  </div>

                  <div class="col-md-4">
                    <label class="form-label">Estado</label>
                    <select id="estadoAula" class="form-control"></select>
                  </div>

                  <div class="col-md-8">
                    <label class="form-label">Nome da sala virtual</label>
                    <input type="text" id="sala_nome" class="form-control">
                  </div>
              ...
              <div class="modal-footer">
                ...
                <button class="btn btn-primary" onclick="registarAula()">Registar</button>
              </div>
            </div>
          </div>
        </div>
        ...
        <!-- MODAL EDITAR -->
        <div class="modal fade" id="modalEditarAula">
          <div class="modal-dialog modal-lg">
            <div class="modal-content">
              <div class="modal-header">
              ...
              <div class="modal-body">
                <input type="hidden" id="aula_id_edit">
                <div class="row g-3">

                  <div class="col-md-4">
                    <label class="form-label">Título</label>
                    <input type="text" id="tituloAulaEdit" class="form-control">
                  </div>

                  <div class="col-md-8">
                    <label class="form-label">Descrição</label>
                    <input type="text" id="descricaoAulaEdit" class="form-control">
                  </div>

                  <div class="col-md-6">
                    <label class="form-label">Data / Hora</label>
                    <input type="datetime-local" id="dataInicioEdit" class="form-control">
                  </div>

                  <div class="col-md-3">
                    <label class="form-label">Duração</label>
                    <input type="number" id="duracaoAulaEdit" class="form-control">
                  </div>

                  <div class="col-md-3">
                    <label class="form-label">Limite</label>
                    <input type="number" id="limiteAulaEdit" class="form-control">
                  </div>

                  <div class="col-md-5">
                    <label class="form-label">Nível</label>
                    <select id="nivelAulaEdit" class="form-control">
                      <option value="Iniciante">Iniciante</option>
                      <option value="Intermédio">Intermédio</option>
                      <option value="Avançado">Avançado</option>
                    </select>
                  ...
                  <div class="col-md-3">
                    <label class="form-label">Preço (€)</label>
                    <input type="number" id="precoAulaEdit" class="form-control">
                  </div>

                  <div class="col-md-4">
                    <label class="form-label">PT</label>
                    <select id="ptAulaEdit" class="form-control"></select>
                  </div>

                  <div class="col-md-4">
                    <label class="form-label">Estado</label>
                    <select id="estadoAulaEdit" class="form-control"></select>
                  </div>

                  <div class="col-md-8">
                    <label class="form-label">Nome da sala virtual</label>
                    <input type="text" id="sala_nomeEdit" class="form-control">
                  </div>
        ...
        <!-- MODAL INSCRITOS -->
        <div class="modal fade" id="modalInscritos">
          <div class="modal-dialog modal-lg">
            <div class="modal-content">
              <div class="modal-header">
              ...
              <div class="modal-body" id="modalInscritosBody"></div>
            </div>
          </div>
        </div>
  ...
  <script src="src/js/aulas_admin.js"></script>
