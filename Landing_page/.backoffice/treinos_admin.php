...
<head>
  <meta charset="utf-8" />
  <title>Gestão de Treinos | Saúde Num Ponto</title>
...
<body>
    ...
    <div id="scrollbar">
      <div class="container-fluid">
        <ul class="navbar-nav" id="navbar-nav">
          ...
          <li class="nav-item">
            <a href="treinos_admin.php" class="nav-link menu-link active">
              <i class="ri-body-scan-line"></i> <span>Gestão de Treinos</span>
            </a>
          </li>
          <li class="nav-item">
        ...
        <div class="row">
          <div class="col-12">
            <div class="page-title-box d-sm-flex align-items-center justify-content-between bg-transparent">
              <h4 class="mb-sm-0">Gestão de Treinos</h4>
            </div>
          </div>
        </div>
        <!-- end page title -->
            ...
            <form id="formNovoTreino">
              ...
              <div class="row">
                ...
                <div class="col-md-6 mb-3">
                  ...
                  <input type="number" class="form-control" name="duracao_min" required>
                </div>
              </div>
              ...
              <div class="row">
                ...
                <div class="col-md-4 mb-3">
                  ...
                  <input type="text" class="form-control" name="grupo_muscular">
                </div>
              ...
              <!-- Preview do Vídeo -->
              <div id="videoPreview" class="my-3 d-none">
                <h6>Pré-visualização do vídeo</h6>
                <iframe id="iframeVideo" width="100%" height="300" style="border:0;" allowfullscreen></iframe>
              </div>

              <!-- Preview da Thumbnail -->
              <div id="thumbPreview" class="my-3 d-none">
                <h6>Thumbnail Gerada</h6>
                <img id="imgThumb" src="" class="img-fluid rounded shadow-sm" style="max-width:300px;">
              </div>

              <button type="submit" class="btn btn-primary mt-3">Guardar Treino</button>
            </form>
          </div>
        </div>
      </div>
  ...
  <script src="src/js/admin_treinos.js"></script>
