...
<body>
                        ...
                        <div class="topbar-page-title d-none d-lg-flex flex-column ms-3">
                            ...
                            <ol class="breadcrumb breadcrumb-sm mb-0">
                                <li class="breadcrumb-item">
                                    <a href="vendas_nutricionista.php">Nutricionista</a>
                                </li>
            ...
            <div id="scrollbar">
                <div class="container-fluid">
                    <ul class="navbar-nav" id="navbar-nav">
                        ...
                        <li class="nav-item">
                            <a href="vendas_nutricionista.php" class="nav-link menu-link active">
                            ...
                            <div class="card shadow-sm p-4 rounded-4 pt-card-lg">
                                ...
                                <div class="card-body">
                                    <form class="row g-3">
                                        ...
                                        <div class="col-12">
                                            <button type="button" class="btn pt-btn w-100 mt-3"
    ...
    <script src="src/js/vendas_nutricionista.js"></script>
