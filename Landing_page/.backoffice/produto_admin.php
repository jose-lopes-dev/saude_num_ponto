...
<body>
    ...
    <div id="scrollbar">
      <div class="container-fluid">
        <ul class="navbar-nav" id="navbar-nav">
          ...
          <li class="nav-item">
            <a href="produto_admin.php" class="nav-link menu-link active">
        ...
        <div class="row">
          <div class="col-12">
            <div class="page-title-box d-sm-flex align-items-center justify-content-between bg-transparent">
              <h4 class="mb-sm-0">Gestão do Marketplace</h4>
            </div>
          </div>
        </div>
        <!-- end page title -->
        ...
        <div class="container py-4">
            ...
            <div class="d-flex justify-content-between align-items-center mb-3">
                <div>
                    ...
                    <small class="text-muted">Administração do marketplace</small>
                </div>
            ...
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    ...
                    <div class="modal-header">
                        <h5 class="modal-title">Registar Produto</h5>
                    ...
                    <div class="modal-body">
                        <div class="row g-3">
                            ...
                            <div class="col-md-6">
                                ...
                                <select class="form-control" id="id_parceiro"></select>
                            </div>
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="button" class="btn btn-primary" onclick="registarProduto()">Guardar</button>
                    </div>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-md-3">
                                <label class="form-label">Preço</label>
                                <input type="number" step="0.01" class="form-control" id="precoEdit">
                            </div>
                            ...
                            <div class="col-md-6">
                                <label class="form-label">Parceiro</label>
                                <select class="form-control" id="parceiroEdit"></select>
                            </div>

                            <div class="col-md-6">
                                <label class="form-label">Estado</label>
                                <select class="form-control" id="editEstado"></select>
                            </div>

                            <div class="col-md-12">
                                <label class="form-label">Imagem (nova)</label>
                                <input type="file" class="form-control" id="imagemEdit">
                            </div>
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Fechar</button>
                        <button type="button" class="btn btn-primary" onclick="guardaEditProduto()">Guardar alterações</button>
                    </div>
  ...
  <script src="src/js/produto_admin.js"></script>
