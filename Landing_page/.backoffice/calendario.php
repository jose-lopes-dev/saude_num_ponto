    ...
    <div id="scrollbar">
      <div class="container-fluid">
        <ul class="navbar-nav" id="navbar-nav">
          ...
          <li class="nav-item">
            <a href="calendario.php" class="nav-link menu-link active">
        ...
        <div class="row">
          <div class="col-12">
            <div class="page-title-box d-sm-flex align-items-center justify-content-between bg-transparent">
              <h4 class="mb-sm-0">Calendário</h4>
            </div>
          </div>
        </div>
                ...
                <form id="form-event" novalidate>
                  ...
                  <div class="mb-3">
                    ...
                    <select class="form-select" id="event-category" required>
                      <option>Obrigações Declarativas</option>
                  ...
                  <div class="mb-3">
                    ...
                    <input type="date" id="event-date-end" class="form-control" required />
                  </div>
                  ...
                  <div class="d-flex justify-content-end gap-2">
                    ...
                    <button type="button" class="btn btn-success" id="btn-conclude-event">Concluir</button>
                    <button type="button" class="btn btn-danger" id="btn-delete-event">Remover</button>
