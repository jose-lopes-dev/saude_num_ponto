...
<head>
    ...
    <meta charset="utf-8" />
    <title>Minhas Aulas | Saúde Num Ponto</title>
    ...
    <link rel="stylesheet" href="src/css/aulas_pt.css">
...
<body>
    ...
    <div id="layout-wrapper">
            ...
            <div id="scrollbar">
                <div class="container-fluid">
                    <ul class="navbar-nav" id="navbar-nav">
                        ...
                        <li class="nav-item">
                            <a href="aulas_pt.php" class="nav-link menu-link active">
            ...
            <div class="page-content">
                <div class="container-fluid">
                    ...
                    <div class="container-fluid my-4">
                        <!-- Container do grid dos cards -->
                        <div id="listaAulasPT" class="aulas-grid">
                    ...
                    <div class="modal fade" id="modalInscritos" tabindex="-1">
                        <div class="modal-dialog modal-dialog-centered modal-lg">
                            <div class="modal-content">
                                ...
                                <div class="modal-body" id="modalInscritosBody">
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <script src="src/js/aulas_pt.js"></script>
