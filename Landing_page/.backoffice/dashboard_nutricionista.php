...
<body>
                        ...
                        <div class="topbar-page-title d-none d-lg-flex flex-column ms-3">
                            ...
                            <ol class="breadcrumb breadcrumb-sm mb-0">
                                <li class="breadcrumb-item">
                                    <a href="dashboard_nutricionista.php">Nutricionista</a>
                                </li>
            ...
            <div id="scrollbar">
                <div class="container-fluid">
                    <ul class="navbar-nav" id="navbar-nav">
                        <li class="nav-item">
                            <a href="dashboard_nutricionista.php" class="nav-link menu-link active">
            ...
            <div class="page-content">
                ...
                ======================== -->
                        <div class="col-lg-8">
                            ...
                            <div class="row g-3 mb-4">
                                ...
                                <!-- KPI: Clientes acompanhados -->
                                <div class="col-md-4">
                                    <div class="card shadow-sm p-4 rounded-4 mt-4 mb-5 cl-card">
                                        <small class="text-muted">Clientes acompanhados</small>
                                        <h3 class="fw-bold mb-0" id="kpi_clientes">--</h3>
                                    </div>
                                </div>

                                <!-- KPI: Consultas Pendentes -->
                                <div class="col-md-4">
                                    <div class="card shadow-sm p-4 rounded-4 mt-4 mb-5 cl-card">
                            ...
                            <div class="card shadow-sm p-4 rounded-4 pt-card-lg">
                                <h5 class="fw-bold mb-2">Consultas por Semana</h5>
                                <p class="text-muted">Resumo das consultas deste mês.</p>
                ...
                ======================= -->
                        <div class="col-lg-4">
                            ...
                            <!-- ÚLTIMOS CLIENTES -->
                            <div class="card shadow-sm p-4 rounded-4 pt-card-lg">
                                <h6 class="fw-bold mb-3">Últimos Clientes Atendidos</h6>

                                <div class="list-group" id="ultimos_clientes">
                                    <!-- Preenchido por JS -->
                                </div>
                            </div>
                            ...
                            <div class="card shadow-sm p-4 rounded-4 pt-card-lg">
                                <h6 class="fw-bold mb-3">Consultas Pendentes</h6>
                            ...
                            <div class="card shadow-sm p-4 rounded-4 pt-card-lg">
                                <h6 class="fw-bold mb-3">Consultas de Hoje</h6>

                                <ul class="list-group list-group-flush" id="consultas_hoje"></ul>
                            </div>
    ...
    <script src="src/js/dashboard_nutricionista.js"></script>
</body>
