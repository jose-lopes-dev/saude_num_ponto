...
<head>
    ...
    <meta charset="utf-8" />
    <title>Aulas | Saúde Num Ponto</title>
    ...
    <link rel="stylesheet" href="src/css/aulas_cliente.css">
    <!-- DataTables CSS -->
...
<body>
    ...
    <div id="layout-wrapper">
            ...
            <div id="scrollbar">
                <div class="container-fluid">
                    <ul class="navbar-nav" id="navbar-nav">
                        ...
                        <li class="nav-item">
                            <a href="aulas_cliente.php" class="nav-link menu-link active">
        ...
        <div class="main-content">
            ...
            <div class="page-content">
                <div class="container-fluid">
                    ...
                    <div class="container-fluid">
                        <div class="row mb-3">
                            <div class="col-md-12">
                                <input id="searchAulas" class="form-control" placeholder="Pesquisar aulas...">
                            </div>
                        </div>
                        ...
                        <div class="row" id="listaAulas">
                            ...
                            <div class="col-12 text-center">
                                <div class="spinner-border text-primary" role="status"><span class="visually-hidden">A
                                        carregar...</span></div>
                            </div>
                        </div>

                        <!-- MODAL DETALHE AULA -->
                        <div class="modal fade" id="modalAulaDetalhe" tabindex="-1">
                            <div class="modal-dialog modal-dialog-centered">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h5 class="modal-title" id="modalAulaTitulo">Aula</h5>
                                        <button class="btn-close" data-bs-dismiss="modal"></button>
                                    </div>
                                    <div class="modal-body">
                                        <p id="modalAulaDescricao"></p>
                                        <p><strong>Data:</strong> <span id="modalAulaData"></span></p>
                                        <p><strong>Duração:</strong> <span id="modalAulaDuracao"></span> min</p>
                                        <p><strong>Limite:</strong> <span id="modalAulaLimite"></span></p>
                                        <p><strong>Preço:</strong> <span id="modalAulaPreco"></span> €</p>
                                        <div id="modalAulaSala" class="mt-2"></div>
                                    </div>
                                    <div class="modal-footer">
                                        <button id="btnInscreverAula" class="btn btn-primary">Inscrever</button>
            ...
            <script src="src/js/aulas_cliente.js"></script>

            <script src="src/js/login.js"></script>

            <script src="src/js/entrar_aula.js"></script>
