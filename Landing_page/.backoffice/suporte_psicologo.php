...
<head>
    ...
    <meta charset="utf-8" />
    <title>Suporte | Saúde Num Ponto</title>
    ...
    <!-- Bootstrap (primeiro de todos os CSS) -->
    ...
    <!-- Select2 (OBRIGATÓRIO para não haver "duplicados") -->
    ...
    <link rel="stylesheet" href="src/css/vendas_nutricionista.css">

    <!-- Layout config (DEPOIS dos CSS) -->
...
<body>
            ...
            <div id="scrollbar">
                <div class="container-fluid">
                    <ul class="navbar-nav" id="navbar-nav">
                        <li class="nav-item">
                            <a href="dashboard_psicologo.php" class="nav-link menu-link">
        ...
        <div class="main-content">
            ...
            <div class="page-content">
                <div class="container-fluid">
                    ...
                    <div class="row mb-4">
                        <div class="col-12">
                            <div class="page-title-box bg-transparent">
                                <h4 class="mb-sm-0 fw-bold text-uppercase">Suporte</h4>
                    ...
                    <div class="row justify-content-center">
                        ...
                        <div class="col-lg-7">
                            <div class="card p-4 shadow-sm rounded-4" id="formSuporte" data-context="user">
                                ...
                                <div class="mb-3">
                                    ...
                                    <select id="suporteAssunto" class="form-select"></select>
                                </div>

                                <!-- MENSAGEM -->
                                <div class="mb-3">
                                    <label class="form-label fw-semibold">Mensagem</label>
                                    <textarea id="suporteMensagem" class="form-control" rows="6"
                                        placeholder="Descreva detalhadamente o problema ou questão..."></textarea>
                                </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="file" id="suporteImagem" class="form-control" accept="image/*">
                                </div>

                                <!-- BOTÃO -->
                                <button type="button" class="btn btn-primary w-100" id="btnEnviarSuporte">
                                    Enviar Pedido
                                </button>
                        ...
                        <div class="col-lg-5 mt-4 mt-lg-0">
                            <div class="card p-4 shadow-sm rounded-4 bg-light">
                                ...
                                <p class="text-muted mb-2">
                                    • Verifique se o seu problema já não foi resolvido anteriormente.
                                </p>
                                <p class="text-muted mb-2">
                                    • Tente explicar ao máximo o que aconteceu para que o suporte responda mais rápido.
                                </p>
                                <p class="text-muted mb-3">
                                    • Caso seja um erro visual, enviar uma imagem ajuda muito a identificar o problema.
                                </p>

                                <hr>

                                <h6 class="fw-bold">Tempo médio de resposta:</h6>
                                <p class="text-success fw-semibold">1 a 24 horas úteis</p>
    ...
    <script src="src/js/suporte.js"></script>
