...
<head>
    ...
    <link rel="stylesheet" href="src/css/clientes_pt.css">
...
<body>
        ...
        <div id="scrollbar">
            <div class="container-fluid">
                <ul class="navbar-nav" id="navbar-nav">
                    ...
                    <li class="nav-item">
                        <a href="clientes_pt.php" class="nav-link menu-link active">
    ...
    <div class="main-content">
        <div class="page-content">
            <div class="container-fluid">
                ...
                $idUtil = $_SESSION['id'];
                $stmt = $conn->prepare("SELECT codigo FROM rh WHERE id_utilizador = ? AND id_funcao = 3");
                ...
                <div class="row g-3 mb-4">
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="pt-card">
                            ...
                            <div class="pt-card-value" id="statTotalClientes">0</div>
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="pt-card">
                            ...
                            <div class="pt-card-value" id="statConsultasSemana">0</div>
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="pt-card">
                            ...
                            <div class="pt-card-value" id="statConsultasFuturas">0</div>
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="pt-card">
                            ...
                            <div class="pt-card-value" id="statTaxaConclusao">0%</div>
                            <small class="text-muted">Últimos 30 dias</small>
                        </div>
                    </div>
                </div>
                <!-- Card: Lista de clientes deste PT -->
                <div class="row">
                    <div class="col-12">
                        <div class="card pt-card-lg pt-table-card pt-dashboard-table shadow-sm">
                            <div class="card-header d-flex justify-content-between align-items-center">
                                <h5 class="mb-0">Clientes</h5>
                                <small class="text-muted" id="labelTotalClientesPt">Total: 0</small>
                            </div>
                            <div class="card-body p-0">
                                <div class="table-responsive">
                                    <table class="table table-striped align-middle mb-0" id="tabelaClientesPt">
                                        <thead>
                                            <tr>
                                                <th>Nome</th>
                                                <th>Email</th>
                                        ...
                                        <tbody id="listaClientesPt">
                                        </tbody>
                                    </table>
                                </div>
                                <div id="semClientesPt" class="text-muted small mt-2" style="display:none;">
                                    Ainda não existem clientes associados a este PT.
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <!-- Modal: Editar cliente PT -->
                <div class="modal fade" id="modalEditarClientePt" tabindex="-1"
                    aria-labelledby="modalEditarClientePtLabel" aria-hidden="true">
                    <div class="modal-dialog modal-xl">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title" id="modalEditarClientePtLabel">Editar cliente</h5>
                                <button type="button" class="btn-close" data-bs-dismiss="modal"
                                    aria-label="Fechar"></button>
                            </div>
                            <div class="modal-body">
                                <form class="row g-3" id="formEditarClientePt">
                                    <input type="hidden" id="idClientePtEdit">
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        <input type="tel" class="form-control" id="telefoneClienteEdit">
                                    </div>

                                    <div class="col-md-3">
                                        <label for="emailClienteEdit" class="form-label">Email</label>
                                        <input type="email" class="form-control" id="emailClienteEdit">
                                    </div>

                                    <div class="col-md-3">
                                        <label for="dataNascClienteEdit" class="form-label">Data de nascimento</label>
                                        <input type="date" class="form-control" id="dataNascClienteEdit">
                                    </div>

                                    <div class="col-md-3">
                                        <label for="estadoClienteEdit" class="form-label">Estado</label>
                                        <select id="estadoClienteEdit" class="form-select">
                                    ...
                                    <div class="col-md-6">
                                        <label for="objetivoClienteEdit" class="form-label">Objetivo principal</label>
                                        <input type="text" class="form-control" id="objetivoClienteEdit">
                                    </div>

                                    <div class="col-12">
                                        <label for="notasClienteEdit" class="form-label">Notas / Observações</label>
                                        <textarea id="notasClienteEdit" class="form-control" rows="2"></textarea>
                                    </div>
                                </form>
                            </div>
                            <div class="modal-footer">
                                <button type="button" class="btn btn-light" data-bs-dismiss="modal">Fechar</button>
                                <button type="button" class="btn btn-primary" id="btnGuardarClientePt">
                                    Guardar alterações
                                </button>
                            </div>
                        </div>
    ...
    <script src="src/js/clientes_pt.js"></script>
