                        ...
                        <div class="topbar-page-title d-none d-lg-flex flex-column ms-3">
                            ...
                            <ol class="breadcrumb breadcrumb-sm mb-0">
                                <li class="breadcrumb-item">
                                    <a href="plano_alimentar_nutricionista.php">Nutricionista</a>
                                </li>
            ...
            <div id="scrollbar">
                <div class="container-fluid">
                    <ul class="navbar-nav" id="navbar-nav">
                        ...
                        <li class="nav-item">
                            <a href="plano_alimentar_nutricionista.php" class="nav-link menu-link active">
                        ...
                        <div class="col-lg-8 mb-4">
                            <div class="card shadow-sm p-4 rounded-4 pt-card-lg">
                                ...
                                <h5 class="mb-3 fw-bold">
                                    <i class="ri-upload-cloud-2-line me-2"></i> Enviar Plano Alimentar
                                </h5>
<div class="mb-3">
    ...
    <select id="clienteId" class="form-select">
        <option value="">Seleciona o cliente</option>
                                ...
                                <div class="mb-3">
                                    <label class="form-label fw-semibold">Ficheiro do Plano</label>
                                    <input type="file" id="ficheiroPlano" class="form-control" accept=".pdf,.doc,.docx">
                                </div>

                                <button class="btn btn-primary w-100" id="btnEnviarPlano">
                        ...
                        <div class="col-lg-8 mb-4">
                            <div class="card shadow-sm p-4 rounded-4 pt-card-lg">
                                ...
                                <h5 class="mb-3 fw-bold">
                                    <i class="ri-history-line me-2"></i> Planos Enviados
                                </h5>

                                <div id="listaPlanosEnviados">
                                    <p class="text-muted">Nenhum plano enviado.</p>
                                </div>
                            </div>
                        </div>
                    </div>
...
<!-- jQuery PRIMEIRO (SEMPRE PRIMEIRO) -->
...
<script src="src/js/plano_alimentar_nutricionista.js"></script>
