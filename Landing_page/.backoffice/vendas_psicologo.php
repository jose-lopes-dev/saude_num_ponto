...
<body>
            ...
            <div id="scrollbar">
                <div class="container-fluid">
                    <ul class="navbar-nav" id="navbar-nav">
                        ...
                        <li class="nav-item">
                            <a href="vendas_psicologo.php" class="nav-link menu-link active">
                        ...
                        <div class="col-12 col-lg-5">
                            <div class="card">
                                <div class="card-header">
                                    <h5 class="card-title mb-0">Registar Venda</h5>
                                </div>
                                ...
                                <div class="card-body">
                                    <form class="row g-3">
                                        ...
                                        <div class="col-12">
                                            ...
                                            <select class="form-select" id="id_cliente"></select>
                                        </div>

                                        <div class="col-12">
                                            <label class="form-label">Sessão de Psicologia</label>
                                            <select class="form-select" id="id_consulta"></select>
                                        </div>

                                        <div class="col-md-6">
                                            <label class="form-label">Data</label>
                                            <input type="date" class="form-control" id="data_venda">
                                        </div>
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <select class="form-select" id="id_estado">
                                                ...
                                                <option value="12">Pago</option>
                                            </select>
                                        </div>

                                        <div class="col-md-6">
                                            <label class="form-label">Valor (€)</label>
                                            <input type="number" step="0.01" class="form-control" id="valor" readonly>
                                        </div>
    ...
    <script src="src/js/vendas_psicologo.js"></script>
