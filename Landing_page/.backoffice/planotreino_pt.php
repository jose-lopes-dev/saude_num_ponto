...
<body>
                        ...
                        <div class="topbar-page-title d-none d-lg-flex flex-column ms-3">
                            ...
                            <ol class="breadcrumb breadcrumb-sm mb-0">
                                <li class="breadcrumb-item">
                                    <a href="planotreino_pt.php">PT</a>
                                </li>
        ...
        <div class="main-content">
            <div class="page-content">
                <div class="container-fluid pt-page">
                    ...
                    <div class="card pt-card-lg mb-3">
                        <div class="card-body">
                            <div class="row g-3 align-items-end pt-topbar">
                                ...
                                <div class="col-md-5 pt-body">
                                    <label class="form-label">Título do plano</label>
                                    <input type="text" id="tituloPlano" class="form-control"
                                        placeholder="Ex: Hipertrofia 4x/semana">
                                </div>

                                <div class="col-md-3 d-grid">
                                    <button id="btnCriarPlano" class="btn btn-success pt-btn">Criar plano</button>
                                </div>
                            ...
                            <div class="card pt-card-lg pt-topbar-card mt-2">
                                <div class="card-header">
                                    <div class="d-flex align-items-center justify-content-between">
                                        <h6 class="mb-0">Adicionar exercícios</h6>
                                        <a id="btnIrExercicios" class="pt-btn-outline-lite"
                                            href="exercicio_pt.php">Gerir exercícios</a>
                                    </div>
                                </div>
                                <div class="card-body">

                                    <div class="row g-2">
                                        <div class="col-6 pt-body">
                                            <label class="form-label">Grupo</label>
                                            <select id="f_grupo_ex" class="select2">
                                        ...
                                        <div class="col-6 pt-body">
                                            ...
                                            <select id="f_equip_ex" class="select2">
                                                <option value="todos">Todos</option>
                                        ...
                                        <div class="col-12">
                                            ...
                                            <select id="id_exercicio" class="select2"></select>
                                        </div>

                                        <div class="col-12 d-grid mt-3">
                                            <button id="btnAddExercicio" class="btn btn-outline-info">Adicionar ao
                                                dia</button>
                                        </div>
                                    ...
                                    <div class="small text-muted">
                                        Dia selecionado: <span id="diaAtualLabel">Segunda</span>
                                    </div>

                                </div>
                            </div>

                            <div class="card pt-card-lg pt-topbar-card mt-3">
                                <div class="card-header">
                                    <h6 class="mb-0">Planos do cliente</h6>
                                </div>
                                <div class="card-body" id="listaPlanosCliente">
                                    <div class="text-muted">Seleciona um cliente…</div>
                                </div>
                            </div>
                        </div>

                        <div class="col-lg-8">
                            <div class="card pt-card-lg pt-table-card pt-topbar-card mt-2">
                                <div class="card-header d-flex align-items-center justify-content-between">
                                    <h6 class="mb-0">Semana</h6>
                                    <button id="btnGuardarDia" class="btn btn-success btn-sm pt-btn">Guardar
                                        dia</button>
                                </div>

                                <div class="card-body">
                                    <div class="pt-dia-top">
                                        <ul class="nav nav-tabs" id="tabsDias">
                                            <li class="nav-item"><button class="nav-link active"
                                                    data-dia="1">Seg</button></li>
                                            <li class="nav-item"><button class="nav-link" data-dia="2">Ter</button></li>
                                            <li class="nav-item"><button class="nav-link" data-dia="3">Qua</button></li>
                                            <li class="nav-item"><button class="nav-link" data-dia="4">Qui</button></li>
                                            <li class="nav-item"><button class="nav-link" data-dia="5">Sex</button></li>
                                            <li class="nav-item"><button class="nav-link" data-dia="6">Sáb</button></li>
                                            <li class="nav-item"><button class="nav-link" data-dia="7">Dom</button></li>
                                        </ul>

                                        <div class="mt-3 pt-dia-header">
                                            <div class="row g-2 align-items-end mb-2">
                                                <div class="col-12 pt-body">
                                                    <label class="form-label">Nome do dia</label>
    ...
    <script src="src/js/planotreino_pt.js"></script>
