...
<head>
    ...
    <link href="src/css/calendarioConsultas.css" rel="stylesheet" type="text/css" />
...
<body>
                ...
                <div class="navbar-header snp-topbar">
                    <div class="d-flex align-items-center">
                        ...
                        <div class="topbar-page-title d-none d-lg-flex flex-column ms-3">
                            <span class="topbar-title">Calendário</span>
                            <ol class="breadcrumb breadcrumb-sm mb-0">
                                <li class="breadcrumb-item">
                                    <a href="calendario_nutricionista.php">Nutricionista</a>
                                </li>
            ...
            <div id="scrollbar">
                <div class="container-fluid">
                    <ul class="navbar-nav" id="navbar-nav">
                        ...
                        <li class="nav-item">
                            <a href="calendario_nutricionista.php" class="nav-link menu-link active">
    ...
    <script src="src/js/calendario_nutricionista.js"></script>
