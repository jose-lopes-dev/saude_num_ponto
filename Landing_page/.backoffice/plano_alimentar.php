...
<head>
    ...
    <meta charset="utf-8" />
    <title>Plano Alimentar | Saúde Num Ponto</title>
    ...
    <link href="src/css/plano_alimentar.css" rel="stylesheet" type="text/css" />
...
<body>
    ...
    <div id="layout-wrapper">
                ...
                <div class="navbar-header snp-topbar">
                    <div class="d-flex align-items-center">
                        ...
                        <div class="topbar-page-title d-none d-lg-flex flex-column ms-3">
                            <span class="topbar-title">Plano Alimentar</span>
                            <ol class="breadcrumb breadcrumb-sm mb-0">
                                <li class="breadcrumb-item">
                                    <a href="dashboard_cliente.php">Cliente</a>
                                </li>
                                <li class="breadcrumb-item active" aria-current="page">Plano Alimentar</li>
                            </ol>
                        </div>
            ...
            <div id="scrollbar">
                <div class="container-fluid">
                    <ul class="navbar-nav" id="navbar-nav">
                        ...
                        <li class="nav-item">
                            <a href="plano_alimentar.php" class="nav-link menu-link active">
        ...
        <div class="main-content">
            <div class="page-content pt-page">
                <div class="container-fluid">
                    ...
                    <div class="row g-4">
                        <!-- ESQUERDA -->
                        <div class="col-lg-6">
                            <div class="card pt-card-lg">
                                <div class="card-header d-flex align-items-center justify-content-between">
                                    <h5 class="mb-0 fw-bold">
                                        <i class="ri-restaurant-line me-2"></i> Criar Plano Alimentar
                                    </h5>
                                    <div class="d-flex justify-content-between align-items-center mb-2">
                                        <small class="text-muted">Total: <span id="novoPlanoTotalKcal" class="fw-bold text-white">0</span> kcal</small>
                                    </div>
                                </div>
                                ...
                                <div class="card-body">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" id="planoTitulo" class="form-control" placeholder="Ex: Almoço - Definição">
                                    </div>

                                    <div class="d-flex align-items-center justify-content-between mb-2">
                                        <h6 class="fw-bold mb-0">Ingredientes</h6>
                                        <button class="pt-btn-outline" type="button" id="btnAddIngrediente">
                                    ...
                                    <div class="d-flex gap-2 mt-3">
                                        <button class="pt-btn w-100" type="button" id="btnGuardarPlano">
                                            <i class="ri-save-line"></i> Guardar
                                        </button>
                                        <button class="pt-btn w-100" type="button" id="btnLimparPlano">
                                            Limpar
                                        </button>
                                    </div>
                                </div>
                        ...
                        <!-- DIREITA -->
                        <div class="col-lg-6">
                            <div class="card pt-card-lg mb-4">
                                <div class="card-body d-flex align-items-center justify-content-between">
                                    <h5 class="mb-0 fw-bold">
                                        <i class="ri-book-2-line me-2"></i> Os Meus Planos
                                    </h5>
                                    <div class="d-flex justify-content-end">
                                        <input id="filtroPlanos" class="form-control" style="max-width: 220px" placeholder="Pesquisar...">
                                    </div>
                                </div>

                                <div class="card-body">
                                    <div id="listaPlanos">
                                        <p class="text-muted mb-0">Nenhum plano criado ainda.</p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="card pt-card-lg">
                                <div class="card-body d-flex align-items-center justify-content-between">
                                    <h5 class="mb-0 fw-bold">
                                        <i class="ri-file-download-line me-2"></i> Planos do Nutricionista
                                    </h5>
                                </div>

                                <div class="card-body">
                                    <div id="listaFicheirosNutricionista">
                                        <p class="text-muted mb-0">Nenhum ficheiro recebido.</p>
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            <div class="modal fade" id="modalVerPlano" tabindex="-1">
                <div class="modal-dialog modal-lg modal-dialog-centered">
                    <div class="modal-content">

                        <div class="modal-header">
                            <h5 class="modal-title" id="modalPlanoTitulo"></h5>
                            <button type="button" class="btn-close" data-bs-dismiss="modal"></button>
                        </div>

                        <div class="modal-body">
                            <h6 class="fw-bold">Total de Calorias:
                                <span id="modalPlanoTotal" class="text-primary"></span>
                            </h6>
                            <hr>
                            <ul id="modalPlanoIngredientes" class="mb-3"></ul>
                        </div>
            ...
            <div class="modal fade" id="modalVerFicheiroNutri" tabindex="-1">
                <div class="modal-dialog modal-xl modal-dialog-centered">
                    <div class="modal-content">
                        <div class="modal-header">
                            <div>
                                <h5 class="modal-title mb-0" id="nutriFileTitulo">Plano do Nutricionista</h5>
                                <small class="text-muted" id="nutriFileData"></small>
                            </div>
                            <button type="button" class="btn-close" data-bs-dismiss="modal"></button>
                        </div>

                        <div class="modal-body">
                            <iframe id="nutriFileFrame"
                                    src=""
                                    style="width: 100%; height: 70vh; border: 0; border-radius: 12px; background: #090A0B;">
                            </iframe>
                        </div>

                        <div class="modal-footer">
                            <a class="btn btn-primary" id="nutriFileDownload" href="#" download>
    ...
    <script src="src/js/plano_alimentar.js"></script>
