            ...
            <div class="card">
              <div class="card-header d-flex justify-content-between align-items-center">
                <h4 class="card-title mb-0">
                  <i class="ri-customer-service-2-line me-1"></i> Pedidos Recebidos
                </h4>
              </div>

              <div class="card-body">
                <div class="table-responsive">
                  <table id="tabelaSuporte" class="table table-striped table-hover w-100">
  ...
  <div class="modal-dialog modal-lg modal-dialog-centered modal-dialog-scrollable">
    <div class="modal-content border-0">
      ...
      <div class="modal-body">
        ...
        <p><strong>Utilizador:</strong> <span id="modalPedidoUser"></span></p>
        <p><strong>Email:</strong> <span id="modalPedidoEmail"></span></p>

        <!-- NOVO -->
        <p><strong>Tipo de Utilizador:</strong> <span id="modalPedidoRole"></span></p>

        <p><strong>Assunto:</strong> <span id="modalPedidoAssunto"></span></p>

        <hr>

        <p class="fw-semibold">Mensagem:</p>
        <div id="modalPedidoMensagem" class="p-3 bg-light rounded border"></div>

        <hr>

        <p class="fw-semibold">Imagem enviada:</p>
        <img id="modalPedidoImagem" class="img-fluid rounded d-none" />
